...
namespace BetterTogether.Areas.Admin.Controllers
{
    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                appointmentViewModel.Appointments = appointmentViewModel.Appointments.Where(a => a.SalesPersonId == claim.Value).ToList();
            }


            //if (searchName != null)
            //{
            //    appointmentViewModel.Appointments = appointmentViewModel.Appointments.Where(a => a.CustName.ToLower().Contains(searchName.ToLower())).ToList();
            //}
            //if (searchEmail != null)
            //{
            //    appointmentViewModel.Appointments = appointmentViewModel.Appointments.Where(a => a.CustEmail.ToLower().Contains(searchEmail.ToLower())).ToList();
            //}
            //if (searchPhone != null)
            //{
            //    appointmentViewModel.Appointments = appointmentViewModel.Appointments.Where(a => a.CustPhoneNumber.ToLower().Contains(searchPhone.ToLower())).ToList();
            //}
            //if (searchDate != null)
            //{
            //    try
